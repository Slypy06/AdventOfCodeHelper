...
public class Helper {
	...
	public static List<Couple<Integer, Integer>> findPath(List<List<Integer>> maze, Couple<Integer, Integer> start, Couple<Integer, Integer> goal, BiFunction<Couple<Integer, Integer>, Couple<Integer, Integer>, Double> heuristic) {
